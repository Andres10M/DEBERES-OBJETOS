...
export class FatherComponent implements AfterViewInit, AfterContentInit {
  parentMessageInput = 'Señor Baldini necesitamos enviar un gran cargmento de perfumes, ya que mañana se celebrara la gran boda real';
  ...
  ngAfterViewInit() {
    Promise.resolve().then(() => {
      this.childComponent.parentMessageViewChild = 'Enviare mi mas grande orgullo el perfume Ammor y Syque(Variables del Hijo) ' +
        'para que queden profundamente enamorados';
    });
  }
